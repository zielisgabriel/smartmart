...
sale_routes.add_url_rule("/list", view_func=listSaleController.listSales, methods=["GET"])
sale_routes.add_url_rule("/create", view_func=createSaleController.createSale, methods=["POST"])
...
sale_routes.add_url_rule("/delete/<int:sale_id>", view_func=deleteSaleController.deleteSale, methods=["DELETE"])
